    ...
    describe('When logged in', function () {
      ...
      describe('Several blogs exist', function () {
        ...
        it('Blogs can be liked', function () {
          cy.contains('Title 1 Author 1').contains('view').click()
          ...
          cy.contains('Title 1 Author 1').contains('likes 1')
        })

        it('Blogs can be removed', function () {
          cy.contains('Title 3 Author 3').contains('view').click()

          cy.contains('Title 3 Author 3').contains('remove').click()
        ...
        it('Only the user that added the blog can see remove button', function () {
          ...
          cy.contains('Title 2 Author 2').contains('view').click()
